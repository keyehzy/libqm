...
template <class InputIt, class Hash = std::hash<typename std::iterator_traits<InputIt>::value_type>,
          class KeyEqual = std::equal_to<typename std::iterator_traits<InputIt>::value_type>>
IndexedHashSet(InputIt, InputIt)
    -> IndexedHashSet<typename std::iterator_traits<InputIt>::value_type, Hash, KeyEqual>;

template <class Key, class Hash = std::hash<Key>, class KeyEqual = std::equal_to<Key>>
IndexedHashSet(std::initializer_list<Key>) -> IndexedHashSet<Key, Hash, KeyEqual>;

template <class Key, class Hash = std::hash<Key>, class KeyEqual = std::equal_to<Key>>
IndexedHashSet(const std::vector<Key>&) -> IndexedHashSet<Key, Hash, KeyEqual>;

template <class Key, class Hash = std::hash<Key>, class KeyEqual = std::equal_to<Key>>
IndexedHashSet(std::vector<Key>&&) -> IndexedHashSet<Key, Hash, KeyEqual>;
